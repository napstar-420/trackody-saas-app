...
export default function WelcomePanel() {
  ...
  return (
    <div
        id='login_left_side'
        className={`${theme === 'light'? 'white-scroll': 'black-scroll'} bg-theme-blue-400 w-full lg:grid place-items-center xl:w-[600px] overflow-y-auto overflow-x-hidden`}
        onClick={toggleTheme}
      >
        <div className='py-6 sm:py-10 lg:px-16 lg:py-16 text-center lg:mt-10'>
          <h1 className='font-secondary text-4xl font-bold'>
            <span className='font-[inherit] text-orange-500'>Trac</span>
